...
@RunWith(Parameterized.class) public class TcpTestCase extends AbstractTabletTestCase {
    ...
    @Parameters public static Collection<Object[]> data() throws UnknownHostException,InterruptedException,ExecutionException {
        ...
        list.add(new InetSocketAddress(Main.defaultTestingHost,Main.defaultReceivePort+serviceOffset));
        list.add(new InetSocketAddress(Main.networkPrefix+Main.myNetworkAddress,Main.defaultReceivePort+serviceOffset));
