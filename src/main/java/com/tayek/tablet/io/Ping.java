...
public class Ping {
    public static void main(String[] args) throws InterruptedException {
        ...
        Message message=Message.ping(tablet.group.groupId,tablet.tabletId());
        ...
        else for(Integer tabletId:group.info().keySet()) {
            // use tablet.group if false
            p("ping tablet: "+tabletId);
            Future<Void> future=tablet.executeTaskAndCancelIfItTakesTooLong(tablet.new SendCallable(message,tabletId,tablet.connectTimeout),tablet.connectTimeout+100,tablet.canceller);
            Thread.sleep(100);
        }
